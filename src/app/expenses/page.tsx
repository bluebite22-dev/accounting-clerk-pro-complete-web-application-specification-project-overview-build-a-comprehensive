...
export default function ExpensesPage() {
  const { transactions, vendors, addTransaction, deleteTransaction } = useDataStore();
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const newTransaction = {
      ...
      category: expenseCategories.find((c) => c.value === formData.category)?.label || "",
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="text-neutral-400">Track and manage your expense transactions</p>
          </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-white">
                    {formatCurrency(expenseTransactions.filter((t) => {
        ...
        <Card>
          ...
          {filteredTransactions.length === 0 && (
            <div className="p-8 text-center">
              <p className="text-neutral-500">No expense transactions found</p>
            </div>
          )}
        </Card>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-2">
              ...
              <Select
                options={[{ value: "", label: "Select category" }, ...expenseCategories]}
